...
model also had a higher AIC than the Negative Binomial model
...
```{r expenditure-predictions, echo=FALSE, include=TRUE}
#### Predictions
####
####
...
Table \@ref(tab:coef-table-expen) and \@ref(tab:coef-table-count)
...
```{r coef-table-expen, results='asis', message=FALSE, warning=FALSE, echo=FALSE}
...
```{r coef-table-count, results='asis', message=FALSE, warning=FALSE, echo=FALSE}
